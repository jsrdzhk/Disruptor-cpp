...
TEST_F(RingBufferTestsFixture, ShouldPreventWrapping)
{
    ...
    EXPECT_EQ(ringBuffer->tryPublishEvent(StubEvent::translator(), 3, std::string("3")), false);
}
...
TEST_F(RingBufferTestsFixture, ShouldPreventProducersOvertakingEventProcessorsWrapPoint)
{
    ...
    EXPECT_EQ(producerComplete, false);
    ...
    EXPECT_EQ(producerComplete, true);
}
...
TEST_F(RingBufferTestsFixture, ShouldPublishEvents)
{
    ...
    EXPECT_EQ(ringBuffer->tryPublishEvents(translators), true);
...
TEST_F(RingBufferTestsFixture, ShouldPublishEventsWithBatchSizeOfOne)
{
    ...
    EXPECT_EQ(ringBuffer->tryPublishEvents(translators, 0, 1), true);
...
TEST_F(RingBufferTestsFixture, ShouldPublishEventsWithinBatch)
{
    ...
    EXPECT_EQ(ringBuffer->tryPublishEvents(translators, 1, 2), true);
...
TEST_F(RingBufferTestsFixture, ShouldPublishEventsOneArg)
{
    ...
    EXPECT_EQ(ringBuffer->tryPublishEvents(translator, { std::string("Foo"), std::string("Foo") }), true);
...
TEST_F(RingBufferTestsFixture, ShouldPublishEventsOneArgBatchSizeOfOne)
{
    ...
    EXPECT_EQ(ringBuffer->tryPublishEvents(translator, 0, 1, { std::string("Foo"), std::string("Foo") }), true);
...
TEST_F(RingBufferTestsFixture, ShouldPublishEventsOneArgWithinBatch)
{
    ...
    EXPECT_EQ(ringBuffer->tryPublishEvents(translator, 1, 2, { std::string("Foo"), std::string("Foo"), std::string("Foo") }), true);
...
TEST_F(RingBufferTestsFixture, ShouldPublishEventsTwoArg)
{
    ...
    EXPECT_EQ(ringBuffer->tryPublishEvents(translator, { std::string("Foo"), std::string("Foo") }, { std::string("Bar"), std::string("Bar") }), true);
...
TEST_F(RingBufferTestsFixture, ShouldPublishEventsTwoArgWithBatchSizeOfOne)
{
    ...
    EXPECT_EQ(ringBuffer->tryPublishEvents(translator, 0, 1, { std::string("Foo2"), std::string("Foo3") }, { std::string("Bar2"), std::string("Bar3") }), true);
...
TEST_F(RingBufferTestsFixture, ShouldPublishEventsTwoArgWithinBatch)
{
    ...
    EXPECT_EQ(ringBuffer->tryPublishEvents(translator, 1, 2, { std::string("Foo3"), std::string("Foo4"), std::string("Foo5") }, { std::string("Bar3"), std::string("Bar4"), std::string("Bar5") }), true);
...
TEST_F(RingBufferTestsFixture, ShouldPublishEventsThreeArg)
{
    ...
    EXPECT_EQ(ringBuffer->tryPublishEvents(translator, { std::string("Foo"), std::string("Foo") }, { std::string("Bar"), std::string("Bar") }, { std::string("Baz"), std::string("Baz") }), true);
...
TEST_F(RingBufferTestsFixture, ShouldPublishEventsThreeArgBatchSizeOfOne)
{
    ...
    EXPECT_EQ(ringBuffer->tryPublishEvents(translator, 0, 1, { std::string("Foo"), std::string("Foo") }, { std::string("Bar"), std::string("Bar") }, { std::string("Baz"), std::string("Baz") }), true);
...
TEST_F(RingBufferTestsFixture, ShouldPublishEventsThreeArgWithinBatch)
{
    ...
    EXPECT_EQ(ringBuffer->tryPublishEvents(translator, 1, 2, { std::string("Foo3"), std::string("Foo4"), std::string("Foo5") },
...
TEST_F(RingBufferTestsFixture, ShouldAddAndRemoveSequences)
{
    ...
    EXPECT_EQ(ringBuffer->removeGatingSequence(sequenceThree), true);
